...
def run_standalone(host='0.0.0.0', port=8080):
    ...
    logger.info(f"📍 Вебхуки будут доступны по адресу: http://{host}:{port}/webhook/yookassa")
...
def main():
    ...
    parser.add_argument('--standalone', action='store_true', help='Запуск в standalone режиме')
